...
#install sqlalchemy in venv and upgrade it: pip install SQLAlchemy then pip install --upgrade sqlalchemy
...
class Task(Base):
    ...
    def __repr__(self):
        return f"Task(prompt={self.prompt}, start_at={self.start_at}, freqency={self.frequency}, task_type={self.task_type})"
